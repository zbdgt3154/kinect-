...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    std::cout << "-----------------------------------" << std::endl;
    std::cout << "---- Have Started Kinect Azrue-----" << std::endl;
    std::cout << "-----------------------------------" << std::endl;
    ...
    while (true)
    {
        if (device.get_capture(&capture)) {
            ...
            normalize(cv_depth, cv_depth_8U, 0, 256*256-1, NORM_MINMAX);
